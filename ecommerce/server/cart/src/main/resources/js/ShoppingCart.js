function ShoppingCart() {
    ...
    this.listcallback = function(resp, smartobj) {
        ...
        if (resp instanceof smartresponse) {
            ...
            {
                smartobj.callback(lresp.list[i].values['cart']);
            }
        }
    };
};

ShoppingCart.prototype = new smart();


function createmessageconn()
{
    var fsmart = new ShoppingCart();
    ...
    fsmart.flowName = 'ShoppingCartFlow';
    return fsmart;
}
